...
Move Op Codes
    ...
    Clear Memory                      ${BASE_ADDRESS_0}  1
    Set Instruction With Length       0  0  0x50010000  False
    Execute Command                   sysbus WriteDoubleWord ${SPARE_RAM_ADDRESS} ${TEST_WORDS}[0]
    ${addr}                           evaluate  ${SEQ0_START_ADDRESS} + 4
    Execute Command                   sysbus WriteDoubleWord ${addr} ${SPARE_RAM_ADDRESS}
    ${addr}                           evaluate  ${SEQ0_START_ADDRESS} + 8
    Execute Command                   sysbus WriteDoubleWord ${addr} ${END_SEQUENCE}
    Start Sequence                    0
    Check Memory Content              ${BASE_ADDRESS_0}  ${TEST_WORDS}  0  1
    Assert SeqAcc IRQ Is Set
    ...
    Clear Memory                      ${BASE_ADDRESS_0}  3
    Set Instruction With Length       0  0  0x50030000  False
    FOR  ${i}  IN RANGE  0  3
        ${addr}                       evaluate  ${SPARE_RAM_ADDRESS} + ${i}*4
        Execute Command               sysbus WriteDoubleWord ${addr} ${TEST_WORDS}[${i}]
        ${addr}                       evaluate  ${SEQ0_START_ADDRESS} + 4 +${i}*4
        Execute Command               sysbus WriteDoubleWord ${addr} ${SPARE_RAM_ADDRESS}
    END
    ...
    Clear Memory                      ${BASE_ADDRESS_0}  3
    Set Instruction With Length       0  0  0x60030000  False
    FOR  ${i}  IN RANGE  0  3
        ${addr}                       evaluate  ${SPARE_RAM_ADDRESS} + ${i}*4
        Execute Command               sysbus WriteDoubleWord ${addr} ${TEST_WORDS}[${i}]
        ${addr}                       evaluate  ${SEQ0_START_ADDRESS} + 4 +${i}*4
    ...
    Clear Memory                      ${SPARE_RAM_ADDRESS}   1
    Set Instruction With Length       0  0  0x50010000  False
    Execute Command                   sysbus WriteDoubleWord ${BASE_ADDRESS_0} ${TEST_WORDS}[0]
    ${addr}                           evaluate  ${SEQ0_START_ADDRESS} + 4
    Execute Command                   sysbus WriteDoubleWord ${addr} ${SPARE_RAM_ADDRESS}
    ${addr}                           evaluate  ${SEQ0_START_ADDRESS} + 8
    Execute Command                   sysbus WriteDoubleWord ${addr} ${END_SEQUENCE}
    Start Sequence                    0
    Check Memory Content              ${SPARE_RAM_ADDRESS}  ${TEST_WORDS}  0  1
    Assert SeqAcc IRQ Is Set
    Clear SeqAcc Interrupt
